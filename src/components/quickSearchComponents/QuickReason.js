      ...
      <div className="QuickReason">
        <div className="form-group" id="reasonDiv">
          ...
          <select className="form-control" id="reason">
            <option value="05">
              05IN: Subject of process or investigation
            </option>
            <option value="00">
              00AC: Transaction log and other audit checks
            </option>
            <option value="01">
              01SC: Vehicle and/or person stopped, i.e. a street check
            </option>
            <option value="02">02MV: Moving vehicle</option>
            <option value="03">
              03AV: Abandoned or parked and unattended vehicle
            </option>
            <option value="04">
              04VC: Vehicles involved in a road traffic collision
            </option>
        ...
        <div className="form-group" id="justificationDiv">
          <label className="form-label" for="justification">
            Supporting Notes
          </label>
