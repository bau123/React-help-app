...
class TabTest extends Component {
  ...
  getData() {
    return (
      <p>
        <b>Princess Peach {new Date().toLocaleString()}</b> (<i>
        ...
        Kingdom, which is constantly under attack by Bowser. She often plays the
        damsel in distress role within the series and is the lead female. She is
    ...
    return (
      <Tabs>
        <TabList>
          ...
          <Tab forceRender={false} onClick={this.isLoad.bind(this)}>
            Peach
          </Tab>
          <Tab>Yoshi</Tab>
          <Tab>Toad</Tab>
        ...
        <TabPanel>
          <p>
            ...
            Shigeru Miyamoto. Serving as the company's mascot and the eponymous
        ...
        <TabPanel>
          {this.state.isDataLoad && this.getData()}
          <p>
            Source:{" "}
            <a
        ...
        <TabPanel>
          <p>
            ...
            appears in many of the Mario spin-off games, including Mario Party
            and Mario Kart, various Mario sports games, and Nintendo's crossover
            fighting game series Super Smash Bros. Yoshi belongs to the species
            of the same name, which is characterized by their variety of colors.
          </p>
          <p>
            Source:{" "}
